/*f not stated otherwise in this file or this component's Licenses.txt file the
...
enum HDR_standard_t {
    ...
    HDR_standard_SDR = 0x04, // Traditional gamma - SDR Luminance Range
    HDR_standard_Traditional_HDR = 0x08, // Traditional gamma - HDR Luminance Range
    HDR_standard_HDR10_PLUS = 0x10, // HDR10+
    HDR_standard_DolbyVision = 0x20 // dolbyvision sink-led or/and source-led
};

enum DV_capability_t {
    DolbyVision_Sink_led = 0x01, // dolbyvision sink-led (standard)
    DolbyVision_Source_led = 0x02, // dolbyvision source-led (low latency)
    DolbyVision_Native = 0x04, // dolbyvision sink-led native 422-12, by default use DolbyVision_Sink_led
    DolbyVision_4K60 = 0x08, // dolbyvision support 4K60
    DolbyVision_444_DeepColor = 0x10 // dolbyvision support 444-10,12bit
};
